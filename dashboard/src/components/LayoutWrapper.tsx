...
export default function LayoutWrapper({ children }: { children: React.ReactNode }) {
  ...
  const [backendUrl, setBackendUrl] = useState("https://whatsacpakash.loca.lt");
  ...
  useEffect(() => {
    ...
    let savedUrl = localStorage.getItem('whatsacp_backend_url') || "https://whatsacpakash.loca.lt";
    if (typeof window !== 'undefined' && window.location.hostname !== 'localhost' && window.location.hostname !== '127.0.0.1') {
      if (savedUrl.includes("localhost") || savedUrl.includes("127.0.0.1") || savedUrl.includes("vercel.app")) {
        ...
        savedUrl = "https://whatsacpakash.loca.lt";
      }
    }
